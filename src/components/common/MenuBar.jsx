...
import chat from '@/assets/imgs/icon/start-chat.svg';
import block from '@/assets/imgs/icon/post-block.svg';
import report from '@/assets/imgs/icon/report.svg';
import link from '@/assets/imgs/icon/export-link.svg';
