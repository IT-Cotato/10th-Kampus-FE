        ...
        <div className="w-full h-full flex flex-col">
            <div className="w-full py-4 bg-white px-4 flex justify-between items-center"
                ...
                <div className="flex gap-6 items-center">
                    <Search className="text-neutral-title w-6 h-6" />
                    <Menubar className="text-neutral-title w-1 h-5" />
                </div>
            </div>
            <div className="flex flex-col px-4 py-3 w-full bg-white gap-[0.875rem]">
                ...
                text-subTitle font-normal py-3 text-[#6A6A6A]">
                    Notice
                </div>
            ...
            <div className="flex flex-col flex-1 w-full bg-white px-4 divide-y-2">
            </div>
        </div>
    )
}
