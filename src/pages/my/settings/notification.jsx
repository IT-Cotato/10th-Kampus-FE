  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex flex-col w-full h-full gap-12 px-4 py-[.625rem]">
          <div className="flex text-neutral-base">Turn on the notification, you can check the popularity right away!</div>
            ...
            <div className="flex flex-col gap-[1.25rem]">
              ...
              <div className="flex flex-col gap-7">
                <div className="flex flex-row items-center justify-between w-full h-full gap-10">
                  ...
                  <Toggle id="message" checked={isToggled1} onChange={handleClickMessageNotificationToggle} />
                </div>
                <div className="flex flex-row items-center justify-between w-full h-full gap-10">
                  <div>Comment notification</div>
                  <Toggle id="comment" checked={isToggled2} onChange={handleClickCommentNotificationToggle} />
                </div>
                <div className="flex flex-row items-center justify-between w-full h-full gap-10">
                  <div>Comment reply notification</div>
                  <Toggle id="reply" checked={isToggled3} onChange={handleClickRelyNotificationToggle} />
                </div>
                <div className="flex flex-row items-center justify-between w-full h-full gap-10">
                  <div>Popular article notification</div>
                  <Toggle id="popular" checked={isToggled4} onChange={handleClickPopularNotificationToggle} />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-7">
                <div className="flex flex-row items-center justify-between w-full h-full gap-10">
                  ...
                  <Toggle id="advertising" checked={isToggled5} onChange={handleClickAdvertisingNotificationToggle} />
                </div>
                <button type="button" className="flex">Terms of use</button>
                <button type="button" className="flex">Privacy Policy</button>
                <div>v 0.0.0</div>
              </div>
            </div>
          </div>
